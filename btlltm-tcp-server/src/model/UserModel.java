...
public class UserModel implements Serializable {
    ...
    public String getStringUser(){
        return userName + "," + password + "," + Double.toString(score) + "," + Integer.toString(win) + "," + Integer.toString(draw) + "," + Integer.toString(lose) + "," + Double.toString(avgCompetitor) + "," + Double.toString(avgTime);
    }
}
